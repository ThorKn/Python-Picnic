...
All the described parts taken together assemble to the Picnic signaturescheme. Picnic consists mainly of two big loops, shown in figure \ref{fig:mainloops}.
\begin{figure}[htbp]
\center
\includegraphics[width=0.5\textwidth]{pics/mainloops.pdf}
\caption{Picnic loops}
\label{fig:mainloops}
\end{figure}\\
